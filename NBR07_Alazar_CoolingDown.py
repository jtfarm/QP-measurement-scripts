...
LOfrequency = np.arange(4.271,4.274,0.0002)
# LOfrequency = np.array([4.27210, 4.27199])

power = np.arange(20,9,-5)
# x = []
# y = []
...
while time.time() < t_end:
    for f in LOfrequency:
        ...
        for p in power:
            ...
            # path = r"G:\Shared drives\LFL\Projects\Quasiparticles\NBR07_TemperatureSweep_Jan2022\CoolingBackDown\{}\\".format(StringForFlux)
            path = r"G:\Shared drives\LFL\Projects\Quasiparticles\NBR07_TemperatureSweep_Jan2022\CoolingBackDown\After11pm\\"
            ...
            savefile = path + 'NBR07_{:.6}GHz_DA{}_{}.bin'.format(freq,str(p),timestamp)
            ...
            with open(savefile[0:-4] + ".txt",'w') as f:
                ...
                f.write("LO frequency: "+ str(freq)[0:6] + " GHz" + '\n')
